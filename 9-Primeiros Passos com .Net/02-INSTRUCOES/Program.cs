...
namespace Instrucoes
{
    class Program
    {
      ...
      static void InstrucaoSwitch(String[] args)
      {
        ...
        static void InsturcoesTryCatchFinallyThrow(string[] args)
        {
        ...
        static void InstrucaoUsings(string[]args)
        {
            ...
            //essa linha é para eliminar o objeto da memória pq não irei mais usar.
            w.Dispose();
        }
    }
}
